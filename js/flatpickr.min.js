...
!(function (e, n) {
  ...
  function E(p, v) {
        ...
        (function (e) {
          ...
          if (void 0 !== a.value && 2 === a.value.length) {
            var u = a === w.hourElement,
              f = a === w.minuteElement;
            d < i
              ? ((d = l + d + r(!u) + (r(u) && r(!w.amPM))),
                f && H(void 0, -1, w.hourElement))
              : d > l &&
                ((d = a === w.hourElement ? d - l - r(!w.amPM) : i),
                f && H(void 0, 1, w.hourElement)),
              w.amPM &&
                u &&
    ...
    function Y(e, n) {
      ...
      n && w.currentYear !== a && (ve("onYearChange"), U()),
        !n ||
    ...
    function j(e) {
      ...
      ~n.className.indexOf("arrow") &&
        H(e, n.classList.contains("arrowUp") ? 1 : -1);
    }
    function H(e, n, t) {
      var a = e && g(e),
      ...
      var t = E(),
        ...
        i =
          void 0 !== e
            ...
            : a
            ? t
            : void 0 !== w.selectedDateElem && ne(w.selectedDateElem)
            ? w.selectedDateElem
            : void 0 !== w.todayDateElem && ne(w.todayDateElem)
            ? w.todayDateElem
            : W(n > 0 ? 1 : -1);
      void 0 === i
        ? w._input.focus()
    ...
    function J(e, n) {
      for (
        ...
        o.appendChild(L("flatpickr-day " + l, new Date(e, n - 1, s), 0, u));
      for (s = 1; s <= i; s++, u++)
        o.appendChild(L("flatpickr-day", new Date(e, n, s), 0, u));
      for (
        var f = i + 1;
        f <= 42 - t && (1 === w.config.showMonths || u % 7 != 0);
        f++, u++
      )
        o.appendChild(L("flatpickr-day " + c, new Date(e, n + 1, f % i), 0, u));
    ...
    function K() {
      if (void 0 !== w.daysContainer) {
        ...
        w.daysContainer.appendChild(e),
          ...
          "range" === w.config.mode && 1 === w.selectedDates.length && ie();
      }
    }
    function U() {
      if (
    ...
    function $() {
      ...
      w.config.showMonths > 1 || "static" === w.config.monthSelectorType
        ...
        : ((w.monthsDropdownContainer = d(
          ...
          N(w.monthsDropdownContainer, "change", function (e) {
            var n = g(e),
      ...
      if (13 === e.keyCode && t) {
        ...
        switch (e.keyCode) {
          ...
          case 40:
            ...
            n === w.altInput
              ? e.ctrlKey
                ? (e.stopPropagation(), X(w.currentYear - s), B(W(1), 0))
                : r || B(void 0, 7 * s)
      ...
      return function (n) {
        ...
        void 0 !== t &&
          ...
          w.selectedDates &&
            ...
            w.selectedDates.length || "min" !== e || O(t),
            Me()),
          w.daysContainer &&
            (de(),
            void 0 !== t
      ...
      clickOpens: [
        function () {
          !0 === w.config.clickOpens
            ? (N(w._input, "focus", w.open), N(w._input, "click", w.open))
    ...
    function ve(e, n) {
      if (void 0 !== w.config) {
        ...
        "onChange" === e &&
          (w.input.dispatchEvent(De("change")),
          w.input.dispatchEvent(De("input")));
      }
    }
    function De(e) {
        ...
        (w.element = w.input = p),
          ...
          (function () {
            ...
            for (
              t
                ...
                u = 0;
              u < w.config.plugins.length;
              u++
            ) {
              var f = w.config.plugins[u](w) || {};
              for (var m in f)
                t.indexOf(m) > -1
                  ? (w.config[m] = c(f[m]).map(k).concat(w.config[m]))
                  : void 0 === i[m] && (w.config[m] = f[m]);
            }
            i.altInputClass ||
              (w.config.altInputClass =
                le().className + " " + w.config.altInputClass),
              ve("onParseConfig");
          })(),
          ce(),
          (w.input = le()),
          ...
          (function () {
            if (
              ...
              var e = l(oe, 50);
              (w._debouncedChange = l(P, 300)),
                w.daysContainer &&
                  !/iPhone|iPad|iPod/i.test(navigator.userAgent) &&
                  N(w.daysContainer, "mouseover", function (e) {
                    "range" === w.config.mode && ie(g(e));
                  }),
                N(w._input, "keydown", ae),
                void 0 !== w.calendarContainer &&
                  N(w.calendarContainer, "keydown", ae),
                w.config.inline || w.config.static || N(window, "resize", e),
                void 0 !== window.ontouchstart
                  ? N(window.document, "touchstart", Q)
                  : N(window.document, "mousedown", Q),
                N(window.document, "focus", Q, { capture: !0 }),
                !0 === w.config.clickOpens &&
                  (N(w._input, "focus", w.open), N(w._input, "click", w.open)),
                void 0 !== w.daysContainer &&
                  (N(w.monthNav, "click", ye),
                  N(w.monthNav, ["keyup", "increment"], A),
                  N(w.daysContainer, "click", fe)),
                void 0 !== w.timeContainer &&
                  void 0 !== w.minuteElement &&
                  void 0 !== w.hourElement &&
                  (N(w.timeContainer, ["increment"], S),
                  N(w.timeContainer, "blur", S, { capture: !0 }),
                  N(w.timeContainer, "click", j),
                  N(
                  ...
                  void 0 !== w.secondElement &&
                    N(w.secondElement, "focus", function () {
                      return w.secondElement && w.secondElement.select();
                    }),
                  void 0 !== w.amPM &&
                    N(w.amPM, "click", function (e) {
                      S(e);
                    })),
          ...
          (w.selectedDates.length || w.config.noCalendar) &&
            (w.config.enableTime &&
              O(w.config.noCalendar ? w.latestSelectedDateObj : void 0),
            Me(!1)),
          I();
